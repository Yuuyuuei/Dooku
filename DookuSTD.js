...
const North = new DeepVerb();
North.Verb = ["#Direction", "go #Direction"]
North.Action = (actor) => {

}

const Look = new DeepVerb();
Look.Verb = ["look", "look around"];
Look.Action = (actor) => {
    actor.LookAround();
}

const Examine = new DeepVerb();
Examine.Verb = ["x #noun", "examine #noun", "look at #noun"];
Examine.Action = (actor, io) => {
    console.log(io.out("tags"));
}

const Put = new DeepVerb();
Put.Verb = ["put #Noun on #Noun"];
Put.Action = (actor) => {
